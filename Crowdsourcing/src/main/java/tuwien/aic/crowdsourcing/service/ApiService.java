...
public class ApiService {
    ...
    public List<Company> searchCompany(String expression)
    {
        ...
        List<Company> matchingCompaniesSynonyms = companyManager
                .findBySynonymsContainingIgnoreCase(expression);
    ...
    public List<Product> searchProduct(String expression)
    {
        ...
        List<Product> matchingCompaniesSynonyms = productManager
                .findBySynonymsContainingIgnoreCase(expression);
        searchResults.addAll(matchingCompaniesSynonyms);
